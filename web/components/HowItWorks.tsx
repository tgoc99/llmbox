...
const steps: Step[] = [
  {
    ...
    title: 'Send an Email',
    description:
      'Compose your question or request in your email client and send it to assistant@mail.llmbox.pro',
  },
  {
    number: 2,
    ...
    title: 'AI Processes',
    description:
      'Our OpenAI-powered system analyzes your message and generates an intelligent, contextual response',
  },
  {
    number: 3,
    ...
    description:
      'Receive a detailed response directly in your inbox within 30 seconds, ready to continue the conversation',
  },
];
                ...
                <div className='flex-1'>
                  <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                    ...
                    <p className='text-gray-800'>
                      Can you help me write a professional email to decline a meeting invitation
                      politely?
                    </p>
                  </div>
                </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div className='flex-1'>
                  <div className='bg-primary-50 border border-primary-200 rounded-lg p-4'>
                    ...
                    <p className='text-gray-800'>
                      I&apos;d be happy to help you craft a polite decline. Here&apos;s a
                      professional template you can customize:
                      <br />
                      <br />
                      &quot;Thank you for the invitation. Unfortunately, I have a prior commitment
                      at that time and won&apos;t be able to attend. I appreciate you thinking of
                      me, and I hope we can find another opportunity to connect soon.&quot;
                      <br />
                      <br />
